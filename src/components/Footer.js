        ...
        <footer className="container-fluid">
            <div className="row text-center">
                ...
                <div className="col-md-4 col-xs-12">
                    ...
                    <a className="white-link" href={t('footer.facebook')} target="_blank"><FontAwesomeIcon icon={['fab', "facebook-f"]} />
                    </a>
                    <a className="white-link" href={t('footer.twitter')} target="_blank"><FontAwesomeIcon icon={['fab', "twitter"]} />
                    </a>
                    <a className="white-link" href={t('footer.instagram')} target="_blank"><FontAwesomeIcon icon={['fab', "instagram"]} />
                    </a>
